...
options.register('outputFilename', 'exerciseII_histos_PF.root',
    VarParsing.multiplicity.singleton,
...
## Initialize analyzer
process.bTaggingExerciseII_PF = cms.EDAnalyzer('BTaggingExerciseII',
...
## Let it run
process.p = cms.Path(process.bTaggingExerciseII_PF)
